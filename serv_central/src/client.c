...
// 	memset(&servidorAddr, 0, sizeof(servidorAddr)); // Zerando a estrutura
// de dados 	servidorAddr.sin_family = AF_INET;
...
// 							sizeof(servidorAddr)) <
// 0) 		printf("Erro no connect()\n");

// 	tamanhoMensagem = strlen(mensagem);

// 	if(send(clienteSocket, mensagem, tamanhoMensagem, 0) != tamanhoMensagem)
// 		printf("Erro no envio: numero de bytes enviados diferente do
// esperado\n");
